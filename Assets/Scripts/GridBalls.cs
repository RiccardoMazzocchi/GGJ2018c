...
public class GridBalls : MonoBehaviour
{
    ...
    {
        GameObject instantiation = Instantiate(scoreBallPrefab, new Vector3(this.transform.position.x, Random.Range(2f, 8f), this.transform.position.z + -3f), Quaternion.identity);
        instantiation.transform.rotation *= Quaternion.Euler(0f, 0f, 180f);
